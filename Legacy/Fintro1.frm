...
Begin VB.Form Fintro 
   ...
   Begin VB.OLE OLE1 
      ...
      Height          =   975
      Left            =   1560
      OleObjectBlob   =   "Fintro1.frx":39A97
      TabIndex        =   7
      Top             =   960
      Visible         =   0   'False
      Width           =   855
   ...
   Begin VB.Label Label5 
      ...
      BackColor       =   &H00000040&
      BorderStyle     =   1  'Fixed Single
      Caption         =   "  Liste des Généraux  Austro-Russes"
      BeginProperty Font 
         Name            =   "Microsoft Sans Serif"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label Label3 
      ...
      BackColor       =   &H00000040&
      BorderStyle     =   1  'Fixed Single
      Caption         =   "  Liste des troupes  Austro-Russes"
      BeginProperty Font 
         Name            =   "Microsoft Sans Serif"
         Size            =   9.75
         Charset         =   0
...
For a = 0 To 1
    For u = 0 To 30
     ...
     Next
Next
If Tour > 1 Then Label6.Caption = 7 + Tour & " à " & 8 + Tour & " heures ( Tour n°" & Tour & ")"
'OLE1.DoVerb
End Sub

Private Sub Command1_Click() 'suite
If OLE1.AppIsRunning = True Then Exit Sub Else Fzone.Show
End Sub
